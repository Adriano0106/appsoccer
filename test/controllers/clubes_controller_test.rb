...
class ClubesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clube" do
    assert_difference('Clube.count') do
      post clubes_url, params: { clube: { birth: @clube.birth, campeonato_id: @clube.campeonato_id, name: @clube.name } }
    end
  ...
  test "should update clube" do
    patch clube_url(@clube), params: { clube: { birth: @clube.birth, campeonato_id: @clube.campeonato_id, name: @clube.name } }
